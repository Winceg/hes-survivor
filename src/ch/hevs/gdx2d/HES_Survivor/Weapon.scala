...
class Weapon(private val bulletType: Int = 0
  ...
  def shoot(position: Vector2, playerBullet: Int): Unit = {
    Game.bullets.append(createBullet(bulletType, position, playerBullet))
  }
  ...
  private def createBullet(bulletType: Int, position: Vector2, playerBullet: Int): Bullet = {
    bulletType match {
      ...
      case 2 => new Bullet(damage = 6, startPos = position, playerBullet = playerBullet, speed = 22, sprite = new Sprite(64, 64, "data/images/spriteSheet/ScalaBullet_64_10.png"))
      case 3 => new Bullet(damage = 7, startPos = position, playerBullet = playerBullet, speed = 14, sprite = new Sprite(64, 64, "data/images/spriteSheet/limit_64_8.png", 0, 8))
    }
  }
}
